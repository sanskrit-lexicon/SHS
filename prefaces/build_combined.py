...
CODE = os.environ.get('DICT', 'shs')
# Source language of SHS front matter is English, so the base .md IS the English
# edition (no separate .en.md per page). We emit a consolidated English file from
# the base .md, plus a consolidated Russian file from the .ru.md pages.
LANGS = {
  'en': ('.md',    f'{CODE}pref_all.en.md', 'Front matter — complete (English)',                'Page',     'Source (scan)'),
