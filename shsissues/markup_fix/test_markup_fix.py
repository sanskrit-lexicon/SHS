"""Synthetic tests for 08_markup_fix.py (SHS)."""
...
line, n = fix_trim_whitespace("<Poem> word </Poem>")
check("<Poem> trim", line, "<Poem>word</Poem>")
check("<Poem> trim n>=1", n>=1, True)
line, n = fix_trim_whitespace("<Poem>clean</Poem>")
check("<Poem> no-op", line, "<Poem>clean</Poem>")
check("<Poem> no-op n", n, 0)
